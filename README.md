...
[`Image-Recognition`](https://github.com/Apollo-Workflows/Image-Recognition)  | An optical Quality Assurance (QA) workflow using OpenCV or alternatively AWS Rekognition and Message Queues  | Amazon, Google |  | ✅ | -
